...
namespace api.core.Features.Branch
{
    public class BranchProvider : IBranchProvider
    {
        ...
        {
            LibGit2Sharp.Branch branchToCheckout = _repository.Branches[checkoutParams.Name];
            ...
            if (branchToCheckout.IsRemote)
            {
                ...
                var newBranch = _repository.CreateBranch(branchToCheckout.FriendlyName.Replace(branchToCheckout.RemoteName + "/", ""), branchToCheckout.Tip.Sha);
